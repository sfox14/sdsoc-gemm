...
#define NUM_PES 8
#define R_DEPTH 21 // A row depth
#define C_DEPTH 190 // A col depth
...
#define NUM_PES 16 
#define R_DEPTH 42 // A row depth: NUM_PES*R_DEPTH <= 480/512
#define C_DEPTH 380 // A col depth: VECTOR_WIDTH*C_DEPTH <= 4480/4608
